...
const Footer = () => {
    return (
        <footer className="footer p-10 lg:bg-gradient-to-r from-pink-800 via-fuchsia-700 to-fuchsia-900 text-neutral-content mt-10">
            ...
            <p className="mt-2 text-center">Developed By Marfater Rahman Jabed</p>
            <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <a href="https://www.facebook.com/marfaterrahman.jabed.5?mibextid=ZbWKwL" target='__blank' className="text-3xl"><BsFacebook></BsFacebook></a>
                <ReactWhatsapp number="+8801827717200" message="Hello World!!!" className="text-3xl"><BsWhatsapp ></BsWhatsapp></ReactWhatsapp>

                <a href="https://www.linkedin.com/in/marfater-rahman-jabed-17541b244/" target='__blank' className="text-3xl"><BsLinkedin></BsLinkedin></a>
                <a href="https://github.com/Marfater-Rahman-Jabed" target='__blank' className="text-3xl"><BsGithub></BsGithub></a>
            </div>
        </footer>
